...
contract NFTMarketplace is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address initialOwner,  IERC20 _token) Ownable(initialOwner) ERC721("BackGroundNFT", "BG") {
        token = _token;   
    }
